...
var KafkaHelper = /** @class */ (function () {
    function KafkaHelper() {
        var _this = this;
        var kafka = new Kafka({
        ...
        this.producer.connect().then(function () {
            // Connected
        });
    ...
    KafkaHelper.prototype.send = function (data, transactionName, topic) {
        return __awaiter(this, void 0, void 0, function () {
            var messageToBeSent, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        messageToBeSent = JSON.stringify(data);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 2:
                        // Send the event data to kafka
                        _a.sent();
                        return [2 /*return*/, { isMessageSent: true }];
                    case 3:
                        error_1 = _a.sent();
